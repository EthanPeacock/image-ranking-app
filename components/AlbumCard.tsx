				...
				<>
					...
					<Card.Content style={{ marginTop: 5 }}>
						<View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
							<Text variant="titleLarge" numberOfLines={1} style={{ width: "80%" }}>Chchc jviviv ugig uguguvi vuvuvjvhv hvu vuvugu vugughv uva</Text>
							<IconButton
						...
						<Text variant="bodySmall" style={{ marginBottom: 15 }}>15 Images</Text>
					</Card.Content>
				</>
			</TouchableRipple>
		</Card>
